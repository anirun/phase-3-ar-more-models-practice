...
PlantCategory.create(plant_id: elephant_bush.id, category_id: outdoor.id)
PlantCategory.create(plant_id: elephant_bush.id, category_id: indoor.id)
PlantCategory.create(plant_id: elephant_bush.id, category_id: leafy.id)
